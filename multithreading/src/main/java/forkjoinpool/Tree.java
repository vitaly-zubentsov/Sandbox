...
/**
 * Класс для создания бинарного дерева с произвольными весами ветвей
 * и методами для подсчета весов в одном потоке и в многопоточном режиме
 */
public class Tree {
    ...
    //Для глубины дерева равной двадцати семи, требуется выделить около 6.5Gb ОЗУ для jvm (-Xmx -Xms)
    private int deepOfTree = 24;
    ...
    public long calculateWeightOfTreeInForkJoinPool(TreeNode node) {
        ...
        //возвращаем результат многопоточных рекурсивных вычислений весов дерева, задав
        // количество потоков равным колличеству доступных процессоров x2
